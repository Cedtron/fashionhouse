    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 lg:border-t-0 lg:bg-transparent lg:dark:bg-transparent lg:justify-end lg:px-0 lg:shadow-none`}
        >
